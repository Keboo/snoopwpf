...
namespace Snoop.Interactive
{
    ...
    public static class InjectorLauncherManager
    {
            ...
            TransientSettingsData transientSettingsData = null)
        {
            ...
            Launch(process.Id, isProcessElevated, architecture, targetHwnd, methodInfo.DeclaringType.Assembly.GetName().Name, methodInfo.DeclaringType.FullName, methodInfo.Name, transientSettingsData.WriteToFile());
        }
